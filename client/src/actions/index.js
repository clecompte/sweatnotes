...
import { FETCH_USER, FETCH_EXERCISES, VIEW_EXERCISE, UPDATE_EXERCISE, DELETE_EXERCISE, DUPLICATE_EXERCISE, EDIT_EXERCISE, ADD_SET } from './types';
...
export const addSet = (id, newSetQuantity, newSetExertion, callback) => async dispatch => {
  const res = await axios.put(`/api/exercises/set/${id}`, { newSetQuantity, newSetExertion });
